...
export default function Navbar(props){
    ...
    return  <div>
        <img className="logoImg" align = "left" src = {process.env.PUBLIC_URL + "/Images/logo.png"}  onClick = {() => {setCategory(""); redirectHandler(history , "/")}}alt  = "Logo"  />
        ...
        <div className="navbar">
            <div className = "sideNav" id = "sideNav">
                ...
                <Collapsible trigger="PORTFOLIO" className = "collapsible" onOpening = {() => {document.getElementById("sideNav").className = "sideNav collapse"}} onClose = {() => {document.getElementById("sideNav").className = "sideNav"}}>
                    {catList.map((cat, index) => <p key = {index} onClick = {() => handleCat(cat)}>{cat}</p>)}
                </Collapsible>
    ...
    <div className = "drawer">
        ...
        <Drawer
              ...
              <div className="swipeableIn">
                    <div className = "sideNav" id = "sideNav">
                        <img className="logoImg2" align = "left" src = {process.env.PUBLIC_URL + "/Images/logo.png"}  onClick = {() => {setCategory(""); redirectHandler(history , "/")}} alt  = "Logo"  />
